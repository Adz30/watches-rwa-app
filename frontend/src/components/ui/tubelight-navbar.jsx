...
// tiny helper for classNames
function cn(...classes) {
  return classes.filter(Boolean).join(" ");
}

export function NavBar({ items, rightComponent, className }) {
  ...
  return (
    <div className={cn("fixed bottom-4 sm:top-4 center -translate-x-1/2 z-50", className)}>
      <div className="flex items-center gap-3 bg-background/5 border border-border backdrop-blur-lg py-1 px-2 rounded-full shadow-lg">
        ...
        {/* optional wallet / network section */}
